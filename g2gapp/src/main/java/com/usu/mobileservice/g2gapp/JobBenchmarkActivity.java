...
public class JobBenchmarkActivity extends AppCompatActivity {
...
//    EditText clientPortText;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case DevUtils.MESSAGE_GO_CONNECTED: {
                    ...
                    UITools.printLog(JobBenchmarkActivity.this, infoText, "Server " + brokerIp);
                    break;
                }
                case DevUtils.MESSAGE_CLIENT_CONNECTED: {
                    ...
                    brokerIp = p2pInfo.groupOwnerAddress.getHostAddress();
                    UITools.printLog(JobBenchmarkActivity.this, infoText, brokerIp);
                    break;
                }
                ...
                case DevUtils.MESSAGE_INFO: {
                    UITools.printLog(JobBenchmarkActivity.this, infoText, msg.obj);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startWFDBridgeBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String routerIp = wfSupport.getRouterWifiInfo(JobBenchmarkActivity.this);

                UITools.showInputDialog2(JobBenchmarkActivity.this, new UITools.InputDialogListener() {
                    @Override
...
//        });
        ...
        getWiFiInfoBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                wfSupport.getWifiInfo(JobBenchmarkActivity.this);
            }
        });
        ...
        startWiFiWorkerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UITools.showInputDialog(JobBenchmarkActivity.this, new UITools.InputDialogListener() {
                    @Override
                    public void inputDone(String resultStr) {
                        // string
        ...
        client = new ServiceBClient(brokerIp, new ReceiveListener() {
            ...
            public void dataReceived(String idChain, String funcName, byte[] data) {
                ...
                if (resp.functionName.equals(NetUtils.BROKER_INFO)) {
                    ...
                    UITools.printLog(JobBenchmarkActivity.this, infoText, " Error " + msg);
                } else if (resp.functionName.equals("sendData")) {
                    String[] msgs = (String[]) resp.outParam.values;
                    long totalTime = System.currentTimeMillis() - startTime;
                    UITools.printLog(JobBenchmarkActivity.this, infoText, msgs[0] + " " + msgs[1] + " in " + totalTime + "ms");
                } else if (resp.functionName.equals("getFolderList")) {
                    String[] files = (String[]) resp.outParam.values;
                    UITools.printLog(JobBenchmarkActivity.this, infoText, "[Client-" + client.client.clientId + "] Received: ");
                    for (int i = 0; i < files.length; i++) {
                        UITools.printLog(JobBenchmarkActivity.this, infoText, "\t File: " + files[i]);
                    }
                }
            }
        });
        ...
        wifiClient = new ServiceBClient(brokerIp, new ReceiveListener() {
            ...
            public void dataReceived(String idChain, String funcName, byte[] data) {
                ...
                if (resp.functionName.equals(NetUtils.BROKER_INFO)) {
                    ...
                    String[] files = (String[]) resp.outParam.values;
                    UITools.printLog(JobBenchmarkActivity.this, infoText, "[Client-" + wifiClient.client.clientId + "] Received: ");
                    for (int i = 0; i < files.length; i++) {
                        UITools.printLog(JobBenchmarkActivity.this, infoText, "\t File: " + files[i]);
                    }
                }
