package com.usu.mobileservice.pubsublib;
...
public class JobHelper {
    ...
    static Job job = null;
    static com.usu.mobileservice.jobex.DataParser dataParser = null;
     ...
     * @return
     */
    public static com.usu.mobileservice.jobex.DataParser getDataParser(Context c, String clientId, byte[] jobBytes) {
        ...
        try {
            ...
            JobHelper.dataParser = (com.usu.mobileservice.jobex.DataParser) dataParserClass.newInstance();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return JobHelper.dataParser;
