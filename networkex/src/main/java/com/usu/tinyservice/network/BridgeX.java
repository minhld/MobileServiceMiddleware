 ...
 *
 */
public class BridgeX extends Thread {
	...
	public BridgeX(String remoteBrokerIp) {
		this.localBrokerIp = NetUtils.DEFAULT_IP;
		this.remoteBrokerIp = remoteBrokerIp;
		this.start();
	}

	public BridgeX(String localBrokerIp, String remoteBrokerIp) {
	 ...
	 */
	public BridgeX(String localBrokerIp, int localWorkerPort,
