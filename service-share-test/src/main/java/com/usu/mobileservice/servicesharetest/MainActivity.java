package com.usu.mobileservice.servicesharetest;
...
import com.usu.mobileservice.pubsublib.Publisher;
import com.usu.mobileservice.pubsublib.Subscriber;
import com.usu.mobileservice.servicesharetest.R;
import com.usu.mobileservice.servicesharetest.UITools;
    ...
    public class ExPublisher extends Publisher {
        ...
        public void send() {
            try {
                ...
                UITools.writeLog(MainActivity.this, infoText, "frame sent: " + stream.size());
                stream.close();
                frmIndex++;
            } catch (Exception e) {
                e.printStackTrace();
